...
function cumlelereDonustur(newCumleler,ayrac=","){
  newCumleler=cumleler.map((x)=>x.join(ayrac));
  return newCumleler;
}
...
function paragrafOlustur(newCumleler,cumleKurFunc,cumlelereDonusturFunc) {
newCumleler=cumlelereDonusturFunc(cumleler," ");
return cumleKurFunc(newCumleler[1],newCumleler[3],newCumleler[5],newCumleler[7],newCumleler[9]);
}
...
console.log(emojileriDonustur(":) :( :d :p :o <3", emojiler));
console.log(emojileriDonustur(":) :( :D :P :O <3", emojiler));
